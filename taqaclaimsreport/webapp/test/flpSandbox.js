		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Claims Report",
									"targetURL": "#taqaclaimsreporttaqaclaimsreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taqaclaimsreporttaqaclaimsreport-display": {
								"semanticObject": "taqaclaimsreporttaqaclaimsreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=taqa.claims.report.taqaclaimsreport",
									"url": sap.ui.require.toUrl("taqa/claims/report/taqaclaimsreport")
								}
							}
						}
					}
